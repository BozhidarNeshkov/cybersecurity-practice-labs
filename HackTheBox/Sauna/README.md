...
This lab demonstrates how small misconfigurations in Active Directory can escalate into full domain compromise.  
A leaked username → AS‑REP roast → weak password → ACL abuse → DCSync → Pass‑the‑Hash → Domain Admin.
